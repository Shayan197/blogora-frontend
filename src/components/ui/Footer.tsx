...
export const Footer = (): React.JSX.Element => {
    ...
    return (
        <footer className="w-full bg-surface border-t border-border-subtle mt-24">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <a
                                ...
                                rel="noreferrer"
                                aria-label="GitHub"
                                className="p-2.5 rounded-full bg-surface-subtle text-text-secondary hover:text-accent-primary hover:border-accent-primary border border-border-subtle transition-colors"
                            >
                        ...
                        <form onSubmit={handleNewsletter} className="space-y-2">
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full pl-3.5 pr-10 py-2 text-xs rounded-xl bg-surface-subtle border border-border-subtle text-text-primary placeholder-text-muted focus:outline-none focus:border-accent-primary transition-colors"
                                />
                                <button
                                    type="submit"
                                    aria-label="Subscribe"
                                    className="absolute right-1.5 top-1.5 p-1 rounded-lg bg-accent-primary text-white hover:bg-accent-primary-hover transition-colors cursor-pointer"
                                >
